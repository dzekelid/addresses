...
- name: AWS Simple Email Service API
  ...
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/addresses/master/_listings/aws-simple-email-service/actionverifyemailaddress-get-openapi.md
- name: AWS Simple Email Service API
  x-api-slug: aws-simple-email-service-api
